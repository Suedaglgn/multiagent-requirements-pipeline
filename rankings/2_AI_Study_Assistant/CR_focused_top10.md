# Top 10 - AI Study Assistant - CS CR-focused

Top 10 orchestration combinations for the **AI Study Assistant** use case, ranked by **CS CR-focused** (0.2 SS / 0.8 CR), averaged over the 5 runs.
